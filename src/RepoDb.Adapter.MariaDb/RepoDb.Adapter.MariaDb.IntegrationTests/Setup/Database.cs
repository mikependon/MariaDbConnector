namespace RepoDb.Adapter.MariaDb.IntegrationTests.Setup
{
    /// <summary>
    ...
    public static class Database
    {
        ...
        public static void Initialize()
        {
            ...
            ConnectionString =
                ...
                "Server=127.0.0.1;Port=3307;Database=RepoDb.Adapter.MariaDb;User ID=root;Password=RepoDB2026;AllowLoadLocalInfile=True;AllowUserVariables=True;";
        ...
        public static void CreateDatabase()
        {
            ...
            Helper.ExecuteNonQuery(connection, "CREATE DATABASE IF NOT EXISTS `RepoDb.Adapter.MariaDb`;");
        }
